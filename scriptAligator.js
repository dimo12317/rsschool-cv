...
let arrPandSrc = ['https://www.youtube.com/embed/R34lYREpOXk','https://www.youtube.com/embed/fafQe4DPdAQ','https://www.youtube.com/embed/b4Zss7BG910']
let arrPandImg = ['OnlineZ.image/mqdefault_6s (5).webp','OnlineZ.image/mqdefault_6s (6).webp','OnlineZ.image/mqdefault_6s (7).webp']
let mainPandMas = ['OnlineZ.image/hqdefault_live (7).webp', 'https://www.youtube.com/embed/EnxRJii_dp8'];
...
let likePandMas = ['OnlineZ.image/mqdefault_6s (5).webp', false, 'OnlineZ.image/mqdefault_6s (6).webp', false, 'OnlineZ.image/mqdefault_6s (7).webp', false, 'OnlineZ.image/hqdefault_live (7).webp', false]
